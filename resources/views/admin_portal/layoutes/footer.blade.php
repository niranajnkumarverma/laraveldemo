<footer class="main-footer">
                ...
                <strong>Copyright &copy; <?php echo date("Y"); ?> <a href="#">Project Management</a>.</strong> All rights reserved.
            </footer>
        </div> <!-- ./wrapper -->
        <!-- ./wrapper -->
         <!-- Start Core Plugins
        =====================================================================-->
        <!-- jQuery -->
        <script src="{{ asset('backend/plugins/jQuery/jquery-1.12.4.min.js') }}" type="text/javascript"></script>
        <!-- jquery-ui --> 
        ...
        <!-- lobipanel -->
        <script src="{{ asset('backend/plugins/lobipanel/lobipanel.min.js') }}" type="text/javascript"></script>
        <!-- Pace js -->
        <script src="{{ asset('backend/plugins/pace/pace.min.js') }}" type="text/javascript"></script>
        <!-- SlimScroll -->
        ...
        <!-- Hadmin frame -->
        <script src="{{ asset('backend/dist/js/custom1.js') }}" type="text/javascript"></script>
        <!-- End Core Plugins
        =====================================================================-->
        ...
        <!-- Data maps js -->
        <script src="{{ asset('backend/plugins/datamaps/d3.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('backend/plugins/datamaps/topojson.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('backend/plugins/datamaps/datamaps.all.min.js') }}" type="text/javascript"></script>
        <!-- Counter js -->
        <script src="{{ asset('backend/plugins/counterup/waypoints.js') }}" type="text/javascript"></script>
        ...
        <script src="{{ asset('backend/plugins/emojionearea/emojionearea.min.js') }}" type="text/javascript"></script>
        <!-- Monthly js -->
...
<!-- Mirrored from thememinister.com/health/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Jul 2022 11:21:12 GMT -->
</html>
